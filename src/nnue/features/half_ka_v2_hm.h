...
class HalfKAv2_hm {
    ...
    static constexpr IndexType PieceSquareIndex[static_cast<int>(Color::COLOR_NB)][PIECE_NB] = {
...
#define B(v) (v * PS_NB)
    // clang-format off
    static constexpr int KingBuckets[static_cast<int>(Color::COLOR_NB)][SQUARE_NB] = {
...
#undef B
    ...
    static constexpr int OrientTBL[static_cast<int>(Color::COLOR_NB)][SQUARE_NB] = {
