...
void update_accumulator_incremental_both(const ActiveFeatureTransformer& featureTransformer,
                                         Square                          white_ksq,
                                         Square                          black_ksq,
                                         AccumulatorState&               target_state,
                                         const AccumulatorState&         computed);
...
void update_accumulator_incremental_both(const ActiveFeatureTransformer& featureTransformer,
    ...
    const auto  pf_stride      = ActiveFeatureTransformer::OutputDimensions;
...
void update_accumulator_refresh_cache(Color                     perspective,
                                      ...
                                      ActiveAccumulatorCache&        cache) {
    constexpr auto Dimensions = ActiveFeatureTransformer::OutputDimensions;
