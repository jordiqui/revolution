...
bool CtgBook::open(const std::string& f) {
    ...
    fs::path basePath(f);
    basePath.replace_extension(".ctg");
    const std::string ctgFile = basePath.string();
    ...
    //CTO
    fs::path ctoPath = basePath;
    ctoPath.replace_extension(".cto");
    const std::string ctoFile = ctoPath.string();
    ...
    //CTB
    fs::path ctbPath = basePath;
    ctbPath.replace_extension(".ctb");
    const std::string ctbFile = ctbPath.string();
    FileMapping ctb;
